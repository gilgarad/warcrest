...
export const SFX_ASSETS: SfxAssetDef[] = [
  ...
  sfx("sfx.combat.bluntAttack", "둔기 공격", "combat", { kind: "heavyImpact", frequency: 210, durationMs: 120 }, { cooldownMs: 90, maxSimultaneous: 4, baseVolume: 0.58, pitchVariation: 0.035 }),
  ...
  sfx("sfx.combat.bowFire", "활 발사", "combat", { kind: "bowTwang", frequency: 610, durationMs: 95 }, { cooldownMs: 85, maxSimultaneous: 5, baseVolume: 0.52, pitchVariation: 0.045 }),
  ...
  sfx("sfx.combat.attackShout", "공격 기합", "combat", { kind: "grunt", frequency: 235, durationMs: 240 }, { cooldownMs: 260, maxSimultaneous: 3, baseVolume: 0.42, pitchVariation: 0.08, volumeVariation: 0.05 }),
