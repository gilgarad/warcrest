...
export const UNIT_STATS: Record<LaneUnitId, UnitStatDef> = {
  ...
  bronze_swordsman: { hp: 42, attack: 12, defense: 5, range: 1.5, speed: 1.1, attackCooldownSec: 0.95, label: "청동검", textureKey: "bronze-swordsman-idle", tint: 0xe1af64 },
  ...
  archer: { hp: 30, attack: 13, defense: 3, range: 5.2, speed: 1.15, attackCooldownSec: 2.0, label: "활", textureKey: "archer-idle", tint: 0x90c6ff },
  iron_swordsman: { hp: 54, attack: 16, defense: 8, range: 1.6, speed: 1.12, attackCooldownSec: 0.9, label: "철검", textureKey: "iron-swordsman-idle", tint: 0xdfe7f4 },
