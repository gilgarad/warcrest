...
export const UNIT_STATS: Record<LaneUnitId, UnitStatDef> = {
  stone_slinger: { hp: 26, attack: 7, defense: 2, range: 4.5, speed: 1.05, attackCooldownSec: 1.3, label: "투석", textureKey: "stone-slinger-w-idle", tint: 0xd4b27c },
  stone_axeman: { hp: 34, attack: 9, defense: 3, range: 1.5, speed: 1.1, attackCooldownSec: 1.0, label: "도끼", textureKey: "stone-axeman-w-idle", tint: 0xa7b1be },
  bronze_swordsman: { hp: 42, attack: 12, defense: 5, range: 1.5, speed: 1.1, attackCooldownSec: 0.95, label: "청동검", textureKey: "bronze-swordsman-w-idle", tint: 0xe1af64 },
  ...
  supply_wagon: { hp: 28, attack: 0, defense: 1, range: 4.4, speed: 0.98, attackCooldownSec: 1.2, healPower: getSupportHealPower("stone"), label: "보급", textureKey: "supply-wagon-w-idle", tint: 0x89da93 },
};
